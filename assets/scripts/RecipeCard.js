...
class RecipeCard extends HTMLElement {
	...
	constructor() {
		...
		let recipeCardShadow = this.attachShadow({mode: 'open'});
  ...
  time {
    ...
    font-size: 12px;
		...
		recipeCardShadow.append(articleElement);
		recipeCardShadow.append(styleElement);
	}
	...
	set data(data) {
		...
		articleElement.innerHTML = `  <img src="https://link-to-article.com/recipe-thumbnail.jpg"
    alt="Recipe Title">
  <p class="title">
